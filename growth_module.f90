...
! Open the output file called 'out_growth.dat'   
    ...
    ENDIF 
    Write(out_growth, '(12(A10,3x))') 'Leaf','Shoots','Stem','Fine_roots','Coarse_roots','Fruits','Reserves','Volume','LAI','Height','Radius_x','Radius_y'
end subroutine read_growth_inputs

subroutine write_growth_outputs
USE maestcom, only: out_growth
Implicit None
	Write(out_growth, '(12(ES12.6,3x))') Biomass_leaf, Biomass_shoots, Biomass_stem, Biomass_froots, Biomass_croots, Biomass_fruits, Reserves, Volume, LAI, H, Rx, Ry
end subroutine 
