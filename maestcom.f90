MODULE maestcom
    ...
    INTEGER, PARAMETER :: TINY = 1.E-30       ! "
    INTEGER, PARAMETER :: EXTRAPARDIM = 75
    ...
    INTEGER, PARAMETER :: USWPLAY = 50    ! modification Mathias d�cembre 2012
...
!    REAL, PARAMETER :: SPERHR = 3600.0 * 24.0 / KHRS ! Seconds in one time interval
    INTEGER :: KHRS                  ! Number of time intervals in a day
    REAL SPERHR,HHRS
